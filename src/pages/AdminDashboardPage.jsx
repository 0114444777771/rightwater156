...
import { Users, DollarSign, Package, ListOrdered, MessageSquare, Bell, BarChart3 } from 'lucide-react';
...
const AdminDashboardPage = () => {
  ...
  const dynamicStats = useMemo(() => {
    const completedOrders = allOrders.filter(order => order.status === 'completed'); // تم التعديل من 'delivered' إلى 'completed'
